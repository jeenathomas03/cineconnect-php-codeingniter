...
<!-- //css files -->
<!-- Web Fonts -->
<link href="payment//fonts.googleapis.com/css?family=Josefin+Sans:100,100i,300,300i,400,400i,600,600i,700,700i&amp;subset=latin-ext" rel="stylesheet">
<!-- //Web Fonts -->
</head>
<body>
<div class="main">	
				...
				<div class="nl-content">
					...
					<form action="" method="post" class="creditly-card-form agileinfo_form">
						...
						<section class="creditly-wrapper wthree w3_agileits_wrapper">
							   ...
							   <input type="submit" value="Make a payment" name="submit" class="btn btn-success">
									</section>
					</form>
					</div>	
				</div>
	...
	<!-- <div class="agileits_copyright">
		<p>© 2023 Card Payment Forms. All rights reserved | Design by <a href="payment/http://w3layouts.com/" target="_blank">UIT KTR</a></p>
	</div> -->
</div><br><br>
<!-- js scripts --> 
<!-- js -->
