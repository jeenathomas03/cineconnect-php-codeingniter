				...
				<div class="collapse navbar-collapse flex-parent" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav flex-child-menu menu-left">
						...
						<li class="dropdown first">
							<a href="<?php echo base_url();?>Major/index">Home</i>
							</a>
						</li>
						<li class="dropdown first">
							...
							<ul class="dropdown-menu level1">
								<li class="dropdown">
									<!-- <a href="" class="dropdown-toggle" data-toggle="dropdown" >Register<i class=""></i></a>
									<ul class="dropdown-menu level2"> -->
										<li><a href="<?php echo base_url();?>Major/reg1">User Register</a></li>
										<li><a href="<?php echo base_url();?>Major/reg2">Theater Register</a></li>
									</ul>
								</li>	
								<li class="dropdown first">
							<a href="<?php echo base_url();?>Major/login">Login</i>
							</a>
						</li>		
		...
		<div class="row">
			<div class="col-md-12">
				<div class="hero-ct">
					<h1>CINECONNECT</h1>
					<ul class="breadcumb">
						<li class="active"><a href="<?php echo base_url();?>Major/index">Home</a></li>
