	...
	<div class="container">
		<div class="row ipad-width2">
			<div class="col-md-12 col-sm-12 col-xs-12">
				...
				<?php if(isset($searchtheater)){
					?>
					<p><?php echo $searchtheater;
					?>
					<?php }else{ ?>
				...
				<div class="celebrity-items">
					<div class="ceb-item">
						<a href="celebritysingle.html"><?php echo $row->theatername;?></a>
						<div class="ceb-infor">
							<h2><a href="celebritylist.html"><?php echo $row->city;?></a></h2>
							<!-- <span>actor, usa</span> -->
							<!-- <span>actor, usa</span> -->
						</div>
					</div>
