<!-- /*
    ...
    */ -->
    ...
    <head>
      ...
      <link rel="stylesheet" href="<?php echo base_url();?>index/css/bootstrap.min.css">
      <link rel="stylesheet" href="<?php echo base_url();?>index/css/owl.carousel.min.css">
      <link rel="stylesheet" href="<?php echo base_url();?>index/css/owl.theme.default.min.css">
      <link rel="stylesheet" href="<?php echo base_url();?>index/fonts/icomoon/style.css">
      <link rel="stylesheet" href="<?php echo base_url();?>index/fonts/feather/style.css">
      <link rel="stylesheet" href="<?php echo base_url();?>index/fonts/flaticon/font/flaticon.css">
      <link rel="stylesheet" href="<?php echo base_url();?>index/css/jquery.fancybox.min.css">
      <link rel="stylesheet" href="<?php echo base_url();?>index/css/aos.css">
    ...
    <body>
            ...
            <div class="row align-items-center">
              ...
              <div class="col-12 col-sm-12 col-lg-12 site-navigation text-center">
                ...
                <ul class="js-clone-nav d-none d-lg-inline-block text-left site-menu float-right menu-absolute">
                  <li class="cta-button"><a href="index/https://untree.co/" target="_blank">Free Templates</a></li>
                </ul>
        ...
        <div class="py-3">
          <div class="container">
            ...
            <div class="owl-logos owl-carousel">
              <div class="item">
                <img src="<?php echo base_url();?>index/images/logo-puma.png" alt="Image" class="img-fluid">
              </div>
              <div class="item">
                <img src="<?php echo base_url();?>index/images/logo-adobe.png" alt="Image" class="img-fluid">
              </div>
              <div class="item">
                <img src="<?php echo base_url();?>index/images/logo-google.png" alt="Image" class="img-fluid">
              </div>
              <div class="item">
                <img src="<?php echo base_url();?>index/images/logo-paypal.png" alt="Image" class="img-fluid">
              </div>
              <div class="item">
                <img src="<?php echo base_url();?>index/images/logo-adobe.png" alt="Image" class="img-fluid">
              </div>
              ...
              <div class="col-lg-7 section-stack order-lg-2 mb-4 mb-lg-0 position-relative" data-aos="fade-up" data-aos-delay="0">
                ...
                <div class="image-stack">
                  <div class="image-stack__item image-stack__item--top">
                    <img src="<?php echo base_url();?>index/images/img_h_2-min.jpg" alt="">
                  </div>
                  <div class="image-stack__item image-stack__item--bottom">
                    <img src="<?php echo base_url();?>index/images/img_h_3-min.jpg" alt="">
                  </div>
                </div>
          ...
          <div class="container">
            ...
            <div class="row feature align-items-center justify-content-between">
              <div class="col-lg-7 mb-4 mb-lg-0 section-stack" data-aos="fade-up" data-aos-delay="0">
                <img src="<?php echo base_url();?>index/images/img_h_5-min.jpg" alt="Image" class="img-fluid">
              </div>
              <div class="col-lg-4 section-title" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="testimonial--wrap">
                  <div class="owl-single owl-carousel no-dots no-nav">
                    <div class="testimonial-item">
                      <div class="d-flex align-items-center mb-4">
                        <div class="photo mr-3">
                          <img src="<?php echo base_url();?>index/images/person_4-min.jpg" alt="Image" class="img-fluid">
                        </div>
                        <div class="author">
                    ...
                    <div class="testimonial-item">
                      <div class="d-flex align-items-center mb-4">
                        <div class="photo mr-3">
                          <img src="<?php echo base_url();?>index/images/person_1-min.jpg" alt="Image" class="img-fluid">
                        </div>
                        <div class="author">
                          <cite class="d-block mb-0">Kaila Woodland</cite>
                          <span>Owner, Greenland, Inc.</span>
                    ...
                    <div class="testimonial-item">
                      <div class="d-flex align-items-center mb-4">
                        <div class="photo mr-3">
                          <img src="<?php echo base_url();?>index/images/person_2-min.jpg" alt="Image" class="img-fluid">
                        </div>
                        <div class="author">
                          <cite class="d-block mb-0">Kaila Woodland</cite>
                          <span>Owner, Greenland, Inc.</span>
            ...
            <div class="row">
              ...
              <div class="col-md-6 mb-5 mb-lg-0 col-lg-4">
                <div class="blog_entry">
                  <a href="#"><img src="<?php echo base_url();?>index/images/img_h_3-min.jpg" alt="Free Website Template by Free-Template.co" class="img-fluid"></a>
              ...
              <div class="col-md-6 mb-5 mb-lg-0 col-lg-4">
                <div class="blog_entry">
                  <a href="#"><img src="<?php echo base_url();?>index/images/img_h_5-min.jpg" alt="Free Website Template by Free-Template.co" class="img-fluid"></a>
                  <div class="p-4 bg-white">
                    <h3><a href="#">Far far away, behind the word mountains</a></h3>
                    <span class="date">April 25, 2019</span>
                    <p>A small river named Duden flows by their place and supplies it with the necessary regelialia.</p>
              ...
              <div class="col-md-6 mb-5 mb-lg-0 col-lg-4">
                <div class="blog_entry">
                  <a href="#"><img src="<?php echo base_url();?>index/images/img_h_7-min.jpg" alt="Free Website Template by Free-Template.co" class="img-fluid"></a>
                  <div class="p-4 bg-white">
                    <h3><a href="#">Far far away, behind the word mountains</a></h3>
                    <span class="date">April 25, 2019</span>
                    <p>A small river named Duden flows by their place and supplies it with the necessary regelialia.</p>
        ...
        <script src="<?php echo base_url();?>index/js/jquery-3.5.1.min.js"></script>
        <script src="<?php echo base_url();?>index/js/jquery-migrate-3.0.0.min.js"></script>
        <script src="<?php echo base_url();?>index/js/popper.min.js"></script>
        <script src="<?php echo base_url();?>index/js/bootstrap.min.js"></script>
        <script src="<?php echo base_url();?>index/js/owl.carousel.min.js"></script>
        <script src="<?php echo base_url();?>index/js/aos.js"></script>
        <script src="<?php echo base_url();?>index/js/imagesloaded.pkgd.js"></script>
        <script src="<?php echo base_url();?>index/js/isotope.pkgd.min.js"></script>
        <script src="<?php echo base_url();?>index/js/jquery.animateNumber.min.js"></script>
        <script src="<?php echo base_url();?>index/js/jquery.stellar.min.js"></script>
        <script src="<?php echo base_url();?>index/js/jquery.waypoints.min.js"></script>
        <script src="<?php echo base_url();?>index/js/jquery.fancybox.min.js"></script>
        <script src="<?php echo base_url();?>index/js/custom.js"></script>
